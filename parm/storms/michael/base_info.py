...
wave_spin_end_date     = tide_spin_start_date + datetime.timedelta(days=20.45833)
...
lonmin_plot_landfall=-87.00
lonmax_plot_landfall=-83.00
latmin_plot_landfall=28.00
latmax_plot_landfall=31.00
...
if run_option == 'tide_spinup':    
    ...
    Ver             = 'v2.0'
    RunName         = 'Michael_OCN_SPINUP'         # Goes to qsub job name
    #inp files
    fetch_hot_from  = None
    ...
    Ver             = 'v2.0' 
    RunName         = 'Michael_OCN_TIDE'           # Goes to qsub job name
    #inp files
    ...
    Ver             = 'v2.0' 
    RunName         = 'Michael_OCN_BEST'           # Goes to qsub job name
    #inp files
    ...
    Ver             = 'v2.0' 
    RunName         = 'Michael_WAV2BEST'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/wind_nhk'
    # Time
    ...
    Ver             = 'v2.0' 
    RunName         = 'Michael_ATM2OCN'           # Goes to qsub job name
    #inp files
    ...
    Ver             = 'v2.0' 
    RunName         = 'Michael_WAV2OCN'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/a21_IKE_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    # Time
    ...
    Ver             = 'v2.0' 
    RunName         = 'Michael_ATM_WAV2OCN'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/a21_IKE_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    #Time
