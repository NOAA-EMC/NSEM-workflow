...
SANDY SANDY SANDY SANDY SANDY SANDY SANDY SANDY  Config file
SANDY SANDY SANDY SANDY SANDY SANDY SANDY SANDY  Config file
SANDY SANDY SANDY SANDY SANDY SANDY SANDY SANDY  Config file
"""
...
#----------------------------------
#Date settings
tide_spin_start_date   = datetime.datetime(2012,10,9,18,0,0) # this is also tde_ref_date (tide_fact calc)
#tide_spin_end_date     = tide_spin_start_date + datetime.timedelta(days=12.5)
#wave_spin_end_date     = tide_spin_start_date + datetime.timedelta(days=21.0)
...
if run_option == 'tide_spinup':    
    ...
    Ver             = 'v2.0'
    RunName         = 'a21_SANDY_OCN_SPINUP'         # Goes to qsub job name
    #inp files
    fetch_hot_from  = None
    ...
    Ver             = 'v2.0' 
    RunName         = 'a21_SANDY_TIDE'           # Goes to qsub job name
    #inp files
    fetch_hot_from  = main_run_dir + '/a21_SANDY_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    fort15_temp     = 'fort.15.template.tide_spinup'           
    # Time
    ...
    Ver             = 'v2.0' 
    RunName         = 'a22_SANDY_BEST'           # Goes to qsub job name
    #inp files
    fetch_hot_from  = main_run_dir + '/a21_SANDY_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    ...
    Ver             = 'v2.0' 
    RunName         = 'a23_SANDY_WAV2BEST'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    fetch_hot_from  = main_run_dir + '/a21_SANDY_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    # Time
    ...
    Ver             = 'v1.0_7t' 
    RunName         = 'a37_SANDY_ATM2OCN'           # Goes to qsub job name
    #inp files
    ...
    Ver             = 'v1.0_7t' 
    RunName         = 'a47_SANDY_WAV2OCN'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/a21_SANDY_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    # Time
    ...
    Ver             = 'v1.0_7t' 
    RunName         = 'a57_SANDY_ATM_WAV2OCN'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/a21_SANDY_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    #Time
