...
#----------------------------------
#Date settings
tide_spin_start_date   = datetime.datetime(2003,8,30,12,0,0) # this is also tde_ref_date (tide_fact calc)
#tide_spin_start_date   = datetime.datetime(2003,9,5,12,0,0) # this is also tde_ref_date (tide_fact calc)
...
# Folders
#main_run_dir    = '/scratch4/COASTAL/coastal/noscrub/Saeed.Moghimi/stmp5/'   # ISABEL test cases
...
#ocn_inp_dir     = 'hsofs_forcings/ISABEL_v1/inp_adcirc/'          #relative to  $app_inp_dir/

mesh = 'hsofs'

#atm_inp_dir     = 'hsofs_forcings/isabel_v2_7settings/inp_atmesh'     
#wav_inp_dir     = 'hsofs_forcings/isabel_v2_7settings/inp_wavdata' 
   
#wave and atm files are 
atm_netcdf_file_names = np.array([
    'ISABEL_HWRF_CFSR_HSOFS.nc',
    ])
...
if run_option == 'tide_spinup':    
    ...
    Ver             = 'v2.0'
    RunName         = 'a21_ISABEL_OCN_SPINUP'         # Goes to qsub job name
    #inp files
    fetch_hot_from  = None
    ...
    Ver             = 'v2.0' 
    RunName         = 'a21_ISABEL_TIDE'           # Goes to qsub job name
    #inp files
    fetch_hot_from  = main_run_dir + '/a21_ISABEL_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    fort15_temp     = 'fort.15.template.tide_spinup'           
    # Time
    ...
    Ver             = 'v2.0' 
    RunName         = 'a22_ISABEL_BEST'           # Goes to qsub job name
    #inp files
    fetch_hot_from  = main_run_dir + '/a21_ISABEL_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    ...
    Ver             = 'v2.0' 
    RunName         = 'a23_ISABEL_WAV2BEST'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    fetch_hot_from  = main_run_dir + '/a21_ISABEL_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    # Time
    ...
    Ver             = 'v1.0_7t' 
    RunName         = 'a37_ISABEL_ATM2OCN'           # Goes to qsub job name
    #inp files
    #fetch_hot_from  = main_run_dir + '/a21_ISABEL_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    fort15_temp     = 'fort.15.template.atm2ocn'           
    # Time
    ...
    Ver             = 'v1.0_7t' 
    RunName         = 'a47_ISABEL_WAV2OCN'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/a21_ISABEL_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    # Time
    ...
    Ver             = 'v1.0_7t' 
    RunName         = 'a57_ISABEL_ATM_WAV2OCN'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/a21_ISABEL_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    #Time
