...
#----------------------------------
#Date settings
tide_spin_start_date   = datetime.datetime(2017,9,3,0,0,0) # this is also tde_ref_date (tide_fact calc)
...
wave_spin_end_date     = tide_spin_start_date + datetime.timedelta(days=26.2083333)
...
# Plotting domains
lonmin_plot_regional=-72.00
lonmax_plot_regional=-54.00
latmin_plot_regional=6.00
latmax_plot_regional=24.00
lonmin_plot_landfall=-67.00
lonmax_plot_landfall=-64.00
latmin_plot_landfall=16.50
latmax_plot_landfall=19.00

# Interval for 90% accuracy analysis
analysis_start_date   = datetime.datetime(2017,9,19,0,0,0)
analysis_end_date   = datetime.datetime(2017,9,22,0,0,0)
...
if run_option == 'tide_spinup':    
    ...
    Ver             = 'v2.0'
    RunName         = 'Maria_OCN_SPINUP'         # Goes to qsub job name
    #inp files
    fetch_hot_from  = None
    ...
    Ver             = 'v2.0' 
    RunName         = 'Maria_OCN_TIDE'           # Goes to qsub job name
    #inp files
    ...
    Ver             = 'v2.0' 
    RunName         = 'Maria_OCN_BEST'           # Goes to qsub job name
    #inp files
    ...
    Ver             = 'v2.0' 
    RunName         = 'Maria_WAV2BEST'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/wind_nhk'
    # Time
    ...
    Ver             = 'v2.0' 
    RunName         = 'Maria_ATM2OCN'           # Goes to qsub job name
    #inp files
    ...
    Ver             = 'v2.0' 
    RunName         = 'Maria_WAV2OCN'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/a21_IKE_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    # Time
    ...
    Ver             = 'v2.0' 
    RunName         = 'Maria_ATM_WAV2OCN'            # Goes to qsub job name
    #inp files
    fort15_temp     = 'fort.15.template.atm2ocn'           
    #fetch_hot_from  = main_run_dir + '/a21_IKE_OCN_SPINUP_v1.0/rt_20170712_h16_m12_s57r072/'
    #Time
